        ...
        <div class="min-w-full align-middle">
            <div class="mb-4">
                <select
                    ...
                    class="block mt-1 w-full sm:w-1/4 text-black rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                >
