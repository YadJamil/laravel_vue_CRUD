                    ...
                    <tr v-for="post in posts.data" :key="post.id">
                        ...
                        >
                            <router-link
                                ...
                                class="rounded-lg px-3 py-2 bg-yellow-500 text-white">Edit</router-link
                            >
                            <a href="#" @click.prevent="deletePost(post.id)" class="ml-1 rounded-lg bg-red-400 text-white px-3 py-2">Delete</a> 
                        </td>
                    </tr>
                </tbody>
            </table>
